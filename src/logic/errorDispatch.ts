// Legacy Mutiny error strings. Bark errors are normalized through the generic
// fallback until the UI grows Bark-specific handling.

// WARNING: autogenerated code, generated by calling:
// Historical generation command:
// `node scripts/errorsToTs.cjs /path/to/backend/src/error.rs`
type MutinyError =
